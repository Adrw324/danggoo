        ...
        children: <Widget>[
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: widget.playerCount < 5
                          ? List.generate((widget.playerCount / 2).ceil(),
                              (index) {
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          Expanded(
                            flex: 4,
                            child: Scaffold(appBar: null, body: null),
                          ),
                          Expanded(
                            flex: 1,
                            child: Center(),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    formattedTime,
                                    style:
                                        TextStyle(fontSize: PlaytimeFontSize),
                                  ),
                                  SizedBox(height: 16),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
              ...
              child: Center(
                child: _isLoading
                    ...
                    : SizedBox(
                        ...
                        child: AspectRatio(
                          aspectRatio: 16 / 9,
                          child: Container(child: playerView),
                        ),
                      ),
              ),
            ),
          ...
          Positioned(
            ...
            child: ElevatedButton(
              onPressed: () {
                setState(() {
                  isFullScreen = !isFullScreen; // 전체 화면 모드 변경
                });
              },
              child: Text(isFullScreen ? '축소' : '전체 화면'),
            ),
          ),
        ],
      ),
