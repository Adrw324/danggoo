...
class _QuickStartScreenState extends State<QuickStartScreen> {
  ...
  Future<void> _startConversion() async {
    ...
    String command =
        '-i rtsp://rtspstream:44a3d7719b78468d6aeec034b0f8abc4@zephyr.rtsp.stream/movie -c:v libx264 -c:a aac -strict experimental -f hls -hls_time 4 -hls_playlist_type event -hls_list_size 0 -hls_segment_filename "output_%03d.ts" output.m3u8';
